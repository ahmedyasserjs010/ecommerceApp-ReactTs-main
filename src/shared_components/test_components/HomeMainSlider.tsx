...
import sliderImg1 from "../../assets/images/Sliders/slide_1.jpg";
import sliderImg2 from "../../assets/images/Sliders/slide_2.jpg";
import sliderImg3 from "../../assets/images/Sliders/slide_3.jpg";
import sliderImg4 from "../../assets/images/Sliders/slide_4.jpg";
import sliderImg5 from "../../assets/images/Sliders/slide_5.jpg";
...
export default function HomeMainSlider() {
    ...
    return (
        <div id="default-carousel" className="relative w-full group" data-carousel="slide">
            ...
            <div 
                ref={carouselRef}
                className="relative h-60 overflow-hidden rounded-lg md:h-[30rem] cursor-grab active:cursor-grabbing bg-gradient-to-br from-gray-900 to-black"
