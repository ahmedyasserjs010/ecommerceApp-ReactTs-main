      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <FaHeart className="text-orange-500 dark:text-orange-400 text-xl drop-shadow-md" />
              ...
              <div className="flex flex-col items-center text-center w-full">
                <Link to={`/special-products/${product.id}/${product.category?.name}`}>
                ...
                {/* Action Buttons - Now inside each product card */}
                <div className="flex flex-col gap-2 w-full px-3 mt-4 mb-2">
                  <button
                    onClick={(e) => {
                    ...
                    className="bg-orange-500 dark:bg-orange-600 text-white font-semibold px-2 py-2 rounded-md hover:bg-orange-700 dark:hover:bg-orange-500 transition-all duration-500 transform opacity-100 disabled:opacity-50 disabled:cursor-not-allowed"
                    title="Add to Cart"
                  >
                  ...
                  <button
                    ...
                    className="bg-white dark:bg-red-600 text-gray-800 dark:text-white font-semibold px-2 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-red-700 border border-gray-500 dark:border-red-500 transition-all duration-500 transform opacity-100 disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  >
                    {removingProductId === product.id ? (
                      ...
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <span className="text-sm">إزالة من المفضلة</span>
                      </div>
                    )}
                  </button>
                </div>
